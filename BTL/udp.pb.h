...
class HostInfo :
 ...
 public:
  ...
  void clear_isseeder();
  bool isseeder() const;
  void set_isseeder(bool value);
  private:
  bool _internal_isseeder() const;
  void _internal_set_isseeder(bool value);
  public:
...
// bool isSeeder = 3;
inline void HostInfo::clear_isseeder() {
  isseeder_ = false;
}
inline bool HostInfo::_internal_isseeder() const {
  return isseeder_;
}
inline bool HostInfo::isseeder() const {
  // @@protoc_insertion_point(field_get:BTL.HostInfo.isSeeder)
  return _internal_isseeder();
}
inline void HostInfo::_internal_set_isseeder(bool value) {
  
  isseeder_ = value;
}
inline void HostInfo::set_isseeder(bool value) {
  _internal_set_isseeder(value);
  // @@protoc_insertion_point(field_set:BTL.HostInfo.isSeeder)
}
...
// bool isSeeder = 3;
inline void ClientInfo::clear_isseeder() {
  isseeder_ = false;
}
inline bool ClientInfo::_internal_isseeder() const {
  return isseeder_;
}
inline bool ClientInfo::isseeder() const {
  // @@protoc_insertion_point(field_get:BTL.ClientInfo.isSeeder)
  return _internal_isseeder();
}
inline void ClientInfo::_internal_set_isseeder(bool value) {
  
  isseeder_ = value;
}
inline void ClientInfo::set_isseeder(bool value) {
  _internal_set_isseeder(value);
  // @@protoc_insertion_point(field_set:BTL.ClientInfo.isSeeder)
}
